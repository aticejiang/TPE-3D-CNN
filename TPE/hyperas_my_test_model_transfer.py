...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun  5 02:08:51 2019
...
# =============================================================================
    ...
    x = Flatten(name='Flatten_transfer')(x)
    x = Dropout(0.5055)(x)
#    
#    
    x = Dense(512, kernel_initializer=kernel_Initializer,
              kernel_regularizer=kernel_Regularizer, name='dense_transfer')(x)
    x = ELU()(x)
#    
#    
    x = Dense(classes, activation='softmax', kernel_initializer=kernel_Initializer,
              kernel_regularizer=kernel_Regularizer, name='softmax_transfer')(x)
# =============================================================================
#     if include_top:
#         x = Flatten()(x)
