...
# -*- coding: utf-8 -*-
"""
Created on Thu May 17 01:01:59 2018
...
def ResNet50_3D(avg_size, weights=None,input_tensor=None, 
...
#    x = ZeroPadding2D(padding=(3, 3), name='conv1_pad')(img_input)
    x = Conv3D(16, (1, 1, 7), strides=(1, 1, 2), kernel_initializer=kernel_Initializer,
...
# =============================================================================
    ...
    x = conv_block(x, 3, [64, 64, 256], stage=5, block='a')      #[512, 512, 2048] [128, 128, 512]
    x = identity_block(x, 3, [64, 64, 256], stage=5, block='b')
    x = identity_block(x, 3, [64, 64, 256], stage=5, block='c')

    x = AveragePooling3D((avg_size, avg_size ,1), name='avg_pool')(x)
