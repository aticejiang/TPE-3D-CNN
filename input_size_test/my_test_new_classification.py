...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar 30 10:56:28 2018
...
def classification_draw(image, ground_truth, patch_length, data_name, epochs, index_iter = 1, best_weights_path = None, interp = False):
    ...
    model = load_model('resnet_3D_%depoch_%s_%d.h5' % (epochs, data_name, index_iter))
    ...
    classification_map(y_re, gt_IN, 24,
                       '/home/jiang/SSRN-master/resnet_dataset/res3D_%depoch_%s_%d.png' % (epochs, data_name, index_iter))